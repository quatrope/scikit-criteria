...
class RAM(SKCDecisionMakerABC):
    ...
    RAM aims to derive the utility value of each option by aggregating its
    scores over decision criteria and the total ranking is achieved on the
    basis of these utility values. To achieve this goal, RAM employs a simple
    yet efficient aggregating function which is directly proportional to the
    effect generated by all beneficial criteria and inversely proportional to
    the effect generated by all non-beneficial criteria. In fact, RAM is based
    on an aggregating function which mixes the compensatory and partially
    compensatory features in a consistent and informative way. The aggregating
    function of RAM is constructed based on the following assumption: The
    degree of compensation between beneficial and non-beneficial criteria is
    different. In fact, there is a new degree of compensation between these
    criteria which is rare in the literature.
