...
def test_OCRA_hotels():
    ...
    assert np.allclose(result.e_.performance, expected.e_.performance)
    assert np.allclose(result.e_.input_performance, 
                       expected.e_.input_performance)
    assert np.allclose(result.e_.output_performance,
