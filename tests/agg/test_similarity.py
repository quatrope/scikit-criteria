...
from skcriteria.agg.similarity import ARAS
...
def test_ARAS_balezentiene2012reducing():
    ...
    Data from:
        ...
        Reducing Greenhouse Gas Emissions in Grassland Ecosystems of the Central Lithuania:
        Multi-Criteria Evaluation on a Basis of the ARAS Method.

    """
    dm = skcriteria.mkdm(
        [
            [3020.0 , 827.6948, 98, 0.015479, 2.166783, 0.0141  ],  # Ideal solution
            ...
            [1700.0 , 386.1619, 90, 0.029429, 5.888983, 0.022218],  # N_180 P_120
            [1355.0 , 342.1966, 80, 0.0293  , 8.635847, 0.024861],  # N_180 K_150
            [2127.5 , 495.4876, 90, 0.038453, 3.652983, 0.020537],  # N_60 P_40 K_50
            [3020.0 , 827.6948, 97, 0.031774, 11.03944, 0.024359],  # N_180 P_120 K_150
            [2786.0 , 795.0   , 98, 0.021151, 8.952235, 0.023349],  # CP(N_180 P_120 K_150)
        ],
    ...
    expected = RankResult(
        ...
        {
            "score": [0.08926, 0.079211, 0.084055, 0.073215, 0.067523, 0.082115,
                      0.070786, 0.094696, 0.102704, 0.107538],
            "utility": [0.599472, 0.531983, 0.564514, 0.491713, 0.453489, 0.551491,
                        0.475401, 0.635985, 0.689763, 0.722232],
    ...
    assert np.allclose(result.e_.ideal_score, expected.e_.ideal_score, atol=1.0e-4)
